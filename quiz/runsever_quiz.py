...
Решение в одном файле. Логику можно раскидать на несколько файлов. Для примера минимум вынести models отдельно.
Не стал делать, так как задача не огромная, разделять по сути нет смысла. Разве что - хорошую практику показать
"""
import os
import requests
